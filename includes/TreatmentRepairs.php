                            ...
                            <table DIR="RTL" id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                      <?php
                                        ...
                                        $repairStatusNeeded = 1; /*THIS IS STATUS CHOOSER */
                                        $repairStatusName = 'בטיפול';
                                        $customerIdL = null;
                                                    ...
                                                    //////END BODY TABLE GOES HERE////////////
                                                      ...
                                                      echo '<div class="modal-footer">';
                                                	    ...
                                                	    echo '<div id="hiddenFormForUpdateeRepair" style="display:none;"></div>';
                                                		 echo '<button type="button" disabled class="btn btn-default buttonForManagers" onclick="cancelButtun(' .$row['repairId'] .')" id="updateBtnInModalCancel' .$row['repairId'] .'" style="float: left;display: block; margin: auto;">';
                                                		echo 'ביטול';
                                                		echo '</button>'; 
                                                      echo '</div>';
                                                    echo '</div>';
